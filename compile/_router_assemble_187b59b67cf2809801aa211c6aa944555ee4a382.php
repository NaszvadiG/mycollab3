<?php
  ...
  return function ($name, $data, $url_base, $query_arg_separator, $anchor) {
    switch($name) {
      ...
      case 'public_subscriptions_unsubscribe':
        return Router::doAssemble('public_subscriptions_unsubscribe', 'public/subscriptions/unsubscribe', array ( 'controller' => 'public_subscriptions', 'action' => 'unsubscribe', 'module' => 'system', ), $data, $url_base, $query_arg_separator, $anchor);
      ...
      case 'data_source_popup':
        return Router::doAssemble('data_source_popup', 'data-sources/popup', array ( 'controller' => 'data_sources', 'action' => 'popup', 'module' => 'data_sources', ), $data, $url_base, $query_arg_separator, $anchor);
