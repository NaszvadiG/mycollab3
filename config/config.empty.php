<?php
  ...
  define('APPLICATION_MODULES', 'system,discussions,milestones,files,calendar,tasks,status,documents,project_exporter,notebooks,source,tracking,invoicing,todo');
