  ...
  final class AngieApplication {
    ...
    * @param string $filename
    ...
    static function handleFatalError($error) {
      ...
      $error_message .= '<p>Fatal error: Application has failed to executed your request (reason: ' . clean(get_class($error)) . '). Information about this error has been logged and sent to administrator.</p>';
