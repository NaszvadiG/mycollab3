    ...
    if($object instanceof IAttachments) {
      ...
      if($attachments) {
        ...
        foreach($attachments as $attachment) {
          $content .= "<img src='" . AngieApplication::getImageUrl('icons/12x12/manage-attachments.png', ATTACHMENTS_FRAMEWORK) . "'><a href='" . clean($attachment->$view_method(true)) . "' style='margin-left:5px; " . $link_style . "'>" . clean($attachment->getName()) . "</a><span style='margin-left:5px; font-size:9px; color:#91918D;'>" . format_file_size($attachment->getSize()) . "</span><br/>";
        } // foreach
