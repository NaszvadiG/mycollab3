...
<div id="reply_to_comment">
  ...
  {foreach $sections as $section}
    <tr class="reply_to_comment_section {if $section.all_ok}all_ok{else}not_all_ok{/if}">
  ...
  <p id="reply_to_comment_info">{lang}Use this checklist to configure activeCollab's "Reply to Comment" feature. This feature will not work unless all of the listed requirements are met!{/lang}</p>
</div>
