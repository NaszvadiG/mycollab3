  ...
  class IAssigneesImplementation {
    ...
    function getAssignee() {
      if($this->assignee === false) {
        ...
        if($assignee instanceof IUser && $assignee->getState() >= STATE_VISIBLE) {
