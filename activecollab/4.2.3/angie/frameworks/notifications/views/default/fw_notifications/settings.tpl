    ...
    <div id="empty_slate_system_roles" class="empty_slate">
      ...
      <ul class="icon_list">
        <li>
          ...
          <span class="icon_list_description">{lang}System can show that there are new thing happenening in several ways: using number of updates in the lower right corner, by showing notification messages in upper right corner or by updating the list in the background without interuption you{/lang}.<br><br></span>
        </li>
      {if $can_override_channel_settings}
        <li>
