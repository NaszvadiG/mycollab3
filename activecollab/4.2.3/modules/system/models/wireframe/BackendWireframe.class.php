          ...
          switch (OnDemand::getAccountStatus()->getStatus()) {
            ...
            case Ondemand::STATUS_FAILED_PAYMENT:
              if (OnDemand::isAccountOwner($user)) {
                ...
                $message = lang('Last payment for your activeCollab Cloud was not successfull, please <a href=":billing_info_url" target="_blank">click here</a> to update your billing information', array('billing_info_url' => $billing_info_url));
              } // if
              break;
            default:
              $message = null;
