<?php
  ...
  class Companies extends BaseCompanies {
    ...
    function findByProject(Project $project) {
      ...
      $company_ids = DB::executeFirstColumn("SELECT DISTINCT $users_table.company_id FROM $users_table, $project_users_table WHERE $users_table.id = $project_users_table.user_id AND $project_users_table.project_id = ?", $project->getId());
